const setUpSlidingTeasers = () => {
  const slidingTeaserContainers = document.querySelectorAll('.sliding-teasers-container');
...
if (!window.STORYBOOK_ENV) setUpSlidingTeasers();

export default setUpSlidingTeasers;